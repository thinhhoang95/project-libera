  ...
  return (
    <div className="relative border-b border-zinc-200 px-3 py-3">
      ...
      <input
        ...
        className="h-9 w-full rounded-md border border-zinc-300 bg-white px-9 text-sm outline-none transition focus:border-zinc-950"
        placeholder="Search notebooks and files"
        value={query}
        onChange={(event) => onQueryChange(event.target.value)}
      />
      {suggestionsOpen ? (
        <div className="absolute left-3 right-3 top-[3.25rem] z-30 overflow-hidden rounded-md border border-zinc-200 bg-white shadow-lg">
